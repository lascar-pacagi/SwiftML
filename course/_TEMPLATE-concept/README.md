...
3. **Test** as you go: `make lab C=<this-dir>` (and `make oracle F=…` for behavioral parity).
...
file, write `tests/lab.ml` (copy the previous concept's — it's the per-concept CLI the cram tests
