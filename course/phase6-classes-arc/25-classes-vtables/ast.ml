(* AST for concept 25 — a *contract*. It carries every node the concepts before it
...
(* NEW in this concept: a class declaration — stored properties, ONE initializer (v0), methods
