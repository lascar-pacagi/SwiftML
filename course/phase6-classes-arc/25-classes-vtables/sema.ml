(* Sema for concept 25 (skeleton) — classes. Registry, DI, and reference-semantics rules are
   given; you BUILD THE VTABLE (TODO(25a): inherit slots, override in place, append new). *)
