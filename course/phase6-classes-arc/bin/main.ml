(* The `swiftml6` CLI — Phase 6 (classes & ARC). Same surface as `swiftml3`, plus `-O` (run the
   SIL optimizer) and `--sil-opt` (print the optimized SIL):
     swiftml6 build <file.swift> [-O] [-o <out>]
     swiftml6 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>
     swiftml6 --emit-tokens|--emit-ast|--typecheck <file.swift> *)

let usage () =
  prerr_endline "usage: swiftml6 build <file.swift> [-O] [-o <out>]";
  prerr_endline "       swiftml6 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>";
  prerr_endline "       swiftml6 --emit-tokens|--emit-ast|--typecheck <file.swift>";
  exit 2
