...
let has_side_effect : Sil.instr -> bool = function
  ...
  | Sil.Retain _ | Sil.Release _ (* refcount traffic IS behavior: deinit timing — concept 26 *) -> true
  | _ -> false
...
let map_instr (g : Sil.value -> Sil.value) : Sil.instr -> Sil.instr = function
  ...
  | Sil.Retain o -> Sil.Retain (g o)
  | Sil.Release o -> Sil.Release (g o)
...
let value_key (canon : Sil.value -> Sil.value) (rty : Types.ty) : Sil.instr -> string option =
  ...
  | Sil.Alloc_ref _ | Sil.Apply_class _ | Sil.Retain _ | Sil.Release _ -> None
