...
It is green from the first run: all three holes are in lowering, and `--typecheck` stops before
any of them.
...
override diagnostics, definite initialization, `let` properties, and the refusal to `print` or
`==` an aggregate.
