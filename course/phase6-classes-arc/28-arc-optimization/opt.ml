(* The SIL optimizer (given) — Phases 4–5 complete: inline, mem2reg, specialization,
   devirtualization, folding, GVN, DCE. Concept 25 teaches it the class instructions. *)
