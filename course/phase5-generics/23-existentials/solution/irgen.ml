(* FROZEN SOLUTION — concept 23 IRGen: the fixed 3-word existential container + heap boxing.
   (Container layout, inline-or-box write, boxed open, thunk unboxing, casts, abort.) *)
