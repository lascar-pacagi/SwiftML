(* IRGen for concept 23 (skeleton) — the fixed 3-word existential container. The container
   layout, thunk unboxing, and casts are given; you implement the inline-or-box write (TODO(23b))
   and the open read (TODO(23c)).

   IRGen (given otherwise) — lower a SIL module to LLVM IR text. SIL blocks/instructions map nearly
