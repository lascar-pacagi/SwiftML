(* The `swiftml5` CLI — Phase 5 (generics & protocols). Same surface as `swiftml3`, plus `-O` (run the
   SIL optimizer) and `--sil-opt` (print the optimized SIL):
     swiftml5 build <file.swift> [-O] [-o <out>]
     swiftml5 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>
     swiftml5 --emit-tokens|--emit-ast|--typecheck <file.swift> *)

let usage () =
  prerr_endline "usage: swiftml5 build <file.swift> [-O] [-o <out>]";
  prerr_endline "       swiftml5 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>";
  prerr_endline "       swiftml5 --emit-tokens|--emit-ast|--typecheck <file.swift>";
  exit 2
