(* Sema for concept 22 (skeleton) — generic functions. Parsing, type-parameter scoping, and
   constraint plumbing are given; you implement the CALL-SITE INFERENCE (TODO(22-sema)). *)
