(* AST for concept 21 — a *contract*. It carries every node the concepts before it
...
(* NEW in this concept: a protocol declaration — METHOD REQUIREMENTS only (signatures, no
