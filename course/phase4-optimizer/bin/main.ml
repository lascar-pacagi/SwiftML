(* The `swiftml4` CLI — Phase 4 (the optimizer). Same surface as `swiftml3`, plus `-O` (run the
   SIL optimizer) and `--sil-opt` (print the optimized SIL):
     swiftml4 build <file.swift> [-O] [-o <out>]
     swiftml4 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>
     swiftml4 --emit-tokens|--emit-ast|--typecheck <file.swift> *)

let usage () =
  prerr_endline "usage: swiftml4 build <file.swift> [-O] [-o <out>]";
  prerr_endline "       swiftml4 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>";
  prerr_endline "       swiftml4 --emit-tokens|--emit-ast|--typecheck <file.swift>";
  exit 2
