(* AST for concept 39 — a *contract*. It carries every node the concepts before it
...
type class_decl = {
  ...
  is_actor : bool; (* NEW in this concept: `actor` vs `class` *)
  cspan : Token.span;
}
