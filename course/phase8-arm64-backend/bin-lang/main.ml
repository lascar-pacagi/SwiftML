(* The `swiftml9` CLI — Phase 7 (closures & stdlib). Same surface as `swiftml3`, plus `-O` (run the
   SIL optimizer) and `--sil-opt` (print the optimized SIL):
     swiftml9 build <file.swift> [-O] [-o <out>]
     swiftml9 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>
     swiftml9 --emit-tokens|--emit-ast|--typecheck <file.swift> *)

let usage () =
  prerr_endline "usage: swiftml9 build <file.swift> [-O] [-o <out>]";
  prerr_endline "       swiftml9 --emit-sil|--sil-opt|--emit-llvm [-O] <file.swift>";
  prerr_endline "       swiftml9 --emit-tokens|--emit-ast|--typecheck <file.swift>";
  exit 2
