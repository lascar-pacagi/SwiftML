(* SILGen — concept 09 (given, complete; carried from concept 08). Lower the (checked) AST to
   raw, memory-based SIL. In concept 09 you only edit irgen.ml; this file is provided.
