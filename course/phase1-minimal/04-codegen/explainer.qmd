...
`swiftml` is built from the concept directories you have been filling in (`phase1-minimal/bin/dune`
links `swiftml_codegen` → sema → parser → lexer), and `oracle.sh` rebuilds before running it.
